 ...
 */
public class Ferris_David_V5 extends Robot
{
	...
	public void onScannedRobot(ScannedRobotEvent e)
	{
		...
		if (getEnergy() > 20)
		{ //If energy is greater than 20 fire a bullet of power 3
			fire(3);
		}
		
		else if (getEnergy() > 10)
		{ //If energy is greater than 10 fire a bullet of power 2
			fire(2); 
		}		
	
		else if (getEnergy() > 5)
		{ //If energy is greater than 5 fire a bullet of power 1
			fire(1);
		}		

		else
		{ //if my energy does not satisfy any of the above conditions, fire a bullet of power .5
			fire(.5);
		}
